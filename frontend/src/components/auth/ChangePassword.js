        ...
        validate={
            values => {
                ...
                if (!values.repeatedPassword) {
                    errors.repeatedPassword = "Powtórzenie hasła jest wymagane"
                }
                        ...
                        <div className={"wrapper bg-light"}>
                            ...
                            <Row className={"justify-content-center mt-4 no-gutters"}>
                                <Form as={Col} xs={{span: 4}}
                                    ...
                                    <h1 className={"text-center text-uppercase font-weight-light mb-4 text-light"}>Zmiana hasła</h1>
                                    ...
                                    <FormGroup as={Col} className={"text-center"} controlId={"repeatedPassword"}>
                                        <FormLabel
                                            className={"text-light font-weight-light text-uppercase"}>Powtórz hasło</FormLabel>
                                        <FormControl type={"password"} onChange={handleChange} value={values.repeatedPassword}
                                                     onBlur={handleBlur}
